...
if __name__ == '__main__':
  ...
  dataloader = torch.utils.data.DataLoader(dataset, batch_size=args.batch_size,
                            sampler=None, num_workers=args.num_workers, shuffle=False)
...
import pickle
outfile = 'taipei2-loss.pkl'

with open(outfile, 'wb') as f:
      pickle.dump(loss_list, f, pickle.HIGHEST_PROTOCOL)

losslist2=np.argsort(loss_list)
losslist3=[]

for n, loss in enumerate(losslist2):
    if loss>=len(losslist2)-256:
        losslist3.append(n)
        
with open(outfile, 'wb') as f:
      pickle.dump(losslist3, f, pickle.HIGHEST_PROTOCOL)
  
writelist=[]
test_data = open("trainval_taipei2.txt", "r")
...
trainfile="trainval_minetrueloss_taipei2.txt"
