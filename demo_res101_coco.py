...
#  pprint.pprint(cfg)
  ...
  load_name ="models/faster_rcnn_1_10_9771.pth"
...
# convert to pascal labels
pascal_org = np.asarray(['__background__',
...
if not args.coco:
    ...
    print("output has 80 classes")
    allbox2=allbox

import os
target = args.outname

outfile = 'output/baseline/' + target + '-' + args.net + '.pkl'
with open(outfile, 'wb') as f:
      pickle.dump(allbox2, f, pickle.HIGHEST_PROTOCOL)
#print(allbox2)
      
if args.save:
      outfile = 'output/bbox-' + target + '-' + args.net + '.pkl'
      with open(outfile, 'wb') as f:
          pickle.dump(roilist, f, pickle.HIGHEST_PROTOCOL)
      outfile = 'output/feat-' + target + '-' + args.net + '.pkl'
      with open(outfile, 'wb') as f:
