...
# do training
command = "python trainval_net_ds_savemod_coco.py --cuda --dataset pascal_voc_"+target+"coco"+" --net "+args.net+" --r True --s "+SESS+" --checkepoch 40 --checkpoint 625 --checksession 500 --epoch 30  --bs 1 --nw 8  --lr 1e-4"
subprocess.call(command, shell=True)
