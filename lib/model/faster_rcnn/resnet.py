...
def resnet10(pretrained=False):
  ...
  """
  model = ResNet_sm(BasicBlock, [1, 1, 1, 1])
  if pretrained:
...
class resnet(_fasterRCNN):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
    ...
    if num_layers==101:
        ...
        self.model_path = 'data/pretrained_model/custom_64-48,1-96,1-168,2-512,2.pth'
        self.dout_base_model = 168
  ...
  def _init_modules(self):
    ...
    if cfg.RESNET.FIXED_BLOCKS == 3:
        print("resnet base layers not trained")
