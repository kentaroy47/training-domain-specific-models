...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.imdb_name = "voc_2007_trainval"
      args.imdbval_name = "voc_2007_test_jackson"
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  elif  "jackson" in args.dataset:
      args.imdb_name = "voc_2007_trainval"
      args.imdbval_name = "voc_2007_test_"+args.dataset[11:]
      args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]']
  ...
  imdb.evaluate_detections(all_boxes, output_dir+str(args.checksession))
